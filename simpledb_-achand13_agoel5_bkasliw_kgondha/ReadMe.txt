...
When a block has to be replaced, we search from the starting of the list to the first unpinned buffer.
As soon as the suitable candidate is found it is removed from the arraylist and the new block is placed onto the last of the list.
