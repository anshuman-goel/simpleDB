...
public class RecoveryMgr {
	...
	private void doRecover() {
		// Redo phase started.
		System.out.println("Undo phase started");
		...
		while (iter.hasNext()) {
			...
			else if (!committedTxs.contains(rec.txNumber()) && !rollbackTxs.contains(rec.txNumber())) {
				System.out.println("undo rec: " + rec);
				rec.undo(txnum);
			}
		}
		System.out.println("============================================================");
		// Redo phase started.
		((LogRecordIterator) iter).makeForward();
		System.out.println("Redo phase started. Commited transactions: " + committedTxs);
		while (iter.hasNext()) {
			LogRecord rec = iter.next();
			if (committedTxs.contains(rec.txNumber())) {
				rec.redo(txnum);
				System.out.println("redoing rec: " + rec);
			}
		}
